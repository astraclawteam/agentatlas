...
const lockOrgSpaceMutation = `-- name: LockOrgSpaceMutation :exec
SELECT pg_advisory_xact_lock(hashtextextended(
    $1::text || chr(31) || $2::text,
    0
))
`

type LockOrgSpaceMutationParams struct {
	LockEnterpriseID string `json:"lock_enterprise_id"`
	LockOrgScope     string `json:"lock_org_scope"`
}

func (q *Queries) LockOrgSpaceMutation(ctx context.Context, arg LockOrgSpaceMutationParams) error {
	_, err := q.db.Exec(ctx, lockOrgSpaceMutation, arg.LockEnterpriseID, arg.LockOrgScope)
	return err
}
